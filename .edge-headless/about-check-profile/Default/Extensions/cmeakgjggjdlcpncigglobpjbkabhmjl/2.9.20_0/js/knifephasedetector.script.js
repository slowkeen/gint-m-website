window.KnifePhaseDetector =
  ...
  (() => {
    ...
    const phaseByPainIndexMap = new Map([
    ...
    const detectByPaintIndex = (paint_index) => {
      for (const [phaseKey, indexArr] of phaseByPainIndexMap.entries()) {
        if (indexArr.includes(+paint_index)) {
